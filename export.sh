...
cp ~/.bashrc ./tty/bashrc
cp ~/.config/cava/config ./tty/cava.config
cp ~/.config/htop/htoprc  ./tty/htoprc
cp ~/.inputrc ./tty/inputrc
...
cp ~/.config/i3/* ./desktopSpace/i3/
cp  ~/.config/compton.conf ./desktopSpace/compton.conf
cp ~/.config/polybar/config ./desktopSpace/polybar.config
cp ~/.config/rofi/config ./desktopSpace/rofi.config
cp ~/.xbindkeysrc ./desktopSpace/xbindkeysrc
cp ~/.config/terminator/config ./desktopSpace/terminator
cp ~/.Xdefaults ./desktopSpace/Xdefaults
cp ~/.xinitrc ./desktopSpace/xinitrc
